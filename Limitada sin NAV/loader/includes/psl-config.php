 ...
 */
define("HOST", "sql145.main-hosting.eu."); 			// The host you want to connect to. 
define("USER", "u695161566_kubo"); 			// The database username. 
define("PASSWORD", "GDnjGxHpLk08uiHsnU"); 	// The database password. 
define("DATABASE", "u695161566_ltda");             // The database name.
